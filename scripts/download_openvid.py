...
def download_files(output_directory, max_parts):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_directory', type=str, default="covr/data/openvid",
                        help='Path to the dataset directory')
    parser.add_argument('--max_parts', type=int, default=186,
                        help='Number of zip parts to download (0–185); use 1 or 2 for dev')
    args = parser.parse_args()
    download_files(args.output_directory, args.max_parts)
